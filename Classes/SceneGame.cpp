...
bool SceneGame::init()
{
    ...
    listener->onTouchBegan = CC_CALLBACK_2(SceneGame::ccTouchBegan,this);
    listener->onTouchEnded = CC_CALLBACK_2(SceneGame::ccTouchEnded,this);
...
////////////////////////////////////////////////////
bool SceneGame::onTouchBegan(CCTouch*, CCEvent*)
{
    return true;
}

 //点击两次才能移动象棋,一次选择,一次移动
void SceneGame::onTouchEnded(CCTouch* touch, CCEvent*)
{
    // 移动象棋
    if (_selectid == -1)
    {
